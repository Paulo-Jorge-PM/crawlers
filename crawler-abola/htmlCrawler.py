...
class htmlCrawler:
    ...
    def __init__(self, url=None):
        ...
        self.BASE_DOMAINS = ["abola.pt"]#for checking if it is not an external link, can be more than one
        self.SAVE_DIR = "output/html/abola/"
    ...
    def getHtml(self, link, render=False):
        ...
        if render == True:
           ...
           () => {
            ...
            resp.html.render(sleep=1, reload=True)#wait=2, sleep=4, script=js, reload=True 
        return resp
